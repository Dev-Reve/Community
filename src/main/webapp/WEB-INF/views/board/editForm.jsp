...
<body class="is-preload">
		...
		<hr>
		<form name="myForm" action="${Path}/board/editBoard.do" method="post" >
			...
			<table class="table">
				<tr style="width: 100%">
					...
					<td class="content" colspan="3">
						<input type="text" name="title" value="${editboard.title}">
					</td>
				</tr>
<!-- 				<tr style="width: 100%"> -->
...
<!-- 				</tr> -->
				<tr style="width: 100%">
					...
					<td class="content" colspan="3">
						<textarea rows="20" cols="50" name="content">${editboard.content}</textarea>
					</td>
				</tr>
			</table>
